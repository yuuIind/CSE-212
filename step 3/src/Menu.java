	...
	public static void main(String[] args) {
		...
		if(sysCommand == 1){
			...
			if(sysCommand == 1) {
				...
				int playCheck = playSearch(eventName, playList);
				if ( playCheck != -1 ) {
					ticketList[indexTicket] = new PremiereTicket(audienceName, playList[playCheck]);
					indexTicket++;
				...
				int playCheck = playSearch(eventName, playList);
				if ( playCheck != -1 ) {
					ticketList[indexTicket] = new PromotionTicket(audienceName, playList[playCheck], accessCode);
					indexTicket++;
			...
			if(sysCommand == 1) {
				...
				int playCheck = playSearch(eventName, playList);
				if ( playCheck != -1 ) {
					ticketList[indexTicket] = new PremiereTicket(audienceName, seatNumber, playList[playCheck]);
					indexTicket++;
				...
				int playCheck = playSearch(eventName, playList);
				if ( playCheck != -1 ) {
					ticketList[indexTicket] = new PromotionTicket(audienceName, seatNumber, playList[playCheck], accessCode);
					indexTicket++;
